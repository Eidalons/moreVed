...
|НС-13| При компрометации модуля навигации в систему управления были переданы недостоверная информация о местооложении (Нарушено ЦБ 3,6)|
|НС-14| При компрометации модуля навигации злоумышленник передал в систему правления недостверное местоположение что привело к забору материала в месте не соответсвующем заданию (Нарушено ЦБ 1)|

...
- Оператор(находится в ЦЕКЭОБ) и судно взаимодействуют с системами организации водного движения помимо системы планирования водных маршрутов.

Взаимодействие системы

![Контекст](images/RUT-0891.jpg)
